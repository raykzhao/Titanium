...
#define Q 240641
#define Q2 (Q << 1) /* Q*2 */
#define Q_BITS 18 /* 18 bits for a number in Z_q */
...
#define ZQ_BYTPCS 1348
#define ZQ_BYTPCA 735
...
#define NUM_B1 1488 /* Ndec1 */

#define B_BYTE 1 /* 1 random bytes to sample a number in Z_B */
#define LOAD_B load_8

/* c_2 compression bit number
 * discard the least significant 10 bits to make each c_2 coordinate fit in one byte */
#define C2_COMPRESSION_BITS 10
